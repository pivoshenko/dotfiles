...
local volumeBracket =
    sbar.add(
      "bracket",
      constants.items.VOLUME .. ".bracket",
      { volumeValue.name },
      {
        background = {
...
local volumeSlider =
    sbar.add(
      "slider",
      constants.items.VOLUME .. ".slider",
      settings.dimens.graphics.popup.width,
      {
        ...
        sbar.exec(
          ...
          function(available)
            ...
            for device in string.gmatch(available, "[^\r\n]+") do
              local color = settings.colors.subtext1
              ...
              sbar.add(
                "item",
                constants.items.VOLUME .. ".device." .. counter,
                {
                  position = "popup." .. volumeBracket.name,
                  align = "center",
                  ...
                  click_script = 'SwitchAudioSource -s "' ..
                      ...
                      ".device\\.*/ label.color=" ..
                      settings.colors.subtext1 ..
                      " --set $NAME label.color=" .. settings.colors.text
                }
              )
              counter = counter + 1
            end
