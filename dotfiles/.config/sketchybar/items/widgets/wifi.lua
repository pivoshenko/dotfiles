...
wifiUp:subscribe("network_update", function(env)
  local upColor = (env.upload == "000 Bps") and settings.colors.subtext1 or settings.colors.peach
  local downColor = (env.download == "000 Bps") and settings.colors.subtext1 or settings.colors.blue
...
local function copyLabelToClipboard(env)
  ...
  sbar.set(env.NAME, {
    label = {
      string = settings.icons.text.clipboard,
      align = "center",
    }
  })
