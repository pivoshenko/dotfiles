...
class Lazygit(abstract.Tool):
    name: str = "Lazygit"

    extension: str = ".yml"

    source: str = "https://api.github.com/repos/catppuccin/lazygit/contents/themes"
    destination: pathlib.Path = (
        pathlib.Path(__file__).parent.parent / "dotfiles" / ".config" / "lazygit" / "themes"
    )
    ...
    def update(self) -> None:
        ...
        for theme_dir in theme_dirs:
            ...
            for file_info in theme_files:
                ...
                color_name: str = filename.replace(self.extension, "")
